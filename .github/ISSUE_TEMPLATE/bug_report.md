...
1.  **Is this a question about how to use `llm-router`, configure a specific backend, or understand its behavior?**
    *   If yes, please ask your question in our **[GitHub Discussions Q&A section](https://llm-router/discussions/categories/q-a)** instead. This is the best place for community support and usage help.

2.  **Have you checked the [README](https://llm-router/blob/main/README.md) and existing [Discussions](https://llm-router/discussions)?**
